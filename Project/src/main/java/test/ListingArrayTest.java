...
public class ListingArrayTest {
    ...
    public void testListingArrayCanCountNumberOfListing(){
        ...
        assertEquals("main.entities.Listing correct counts the amount of Listings there is", 5, la.getTotalNumOfListing());
    }
    ...
    public void testListingArrayCanHaveOver100Elements(){
        ...
        assertEquals("main.entities.Listing can have over an hundred elements", 300, la.getTotalNumOfListing());
    }
