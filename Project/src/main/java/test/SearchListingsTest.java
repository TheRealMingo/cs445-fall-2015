...
public class SearchListingsTest {
    ...
    public void testCanSearchAdvertiserByEmailAddress() {
        ...
        Listing[] theListings = SearchListings.searchByAdvertisersEmailAddress(aa, la, "carl@carl.com");
        Listing[] expected = {list2, clist2, hlist2};

        assertArrayEquals("Can Obtain Listings from Searching main.entities.Advertiser\'s By Email", expected, theListings);
    }
    ...
    public void testCanSearchAdvertiserByLastName() {
        ...
        Listing[] theListings = SearchListings.searchByAdvertisersLastName(aa, la, "Bill");
        Listing[] expected = {list0, clist0, hlist0};

        assertArrayEquals("Can Obtain Listings from Searching By main.entities.Advertiser\'s Last Name", expected, theListings);
    }
    ...
    public void testCanSearchAdvertiserByBusinessName() {
        ...
        Listing[] theListings = SearchListings.searchByAdvertisersBusinessName(aa, la, "Heroes.org");
    ...
    public void testCanSearchAdvertiserByPhoneNumber() {
        ...
        Listing[] theListings = SearchListings.searchByAdvertisersPhoneNumber(aa, la, "(654)586-9843");
        Listing[] expected = {list4, clist4};

        assertArrayEquals("Can Obtain Listings from Searching By main.entities.Advertiser\'s Phone Number", expected, theListings);
    }
    ...
    public void testCanSearchBySocialMedia() {
        ...
        adv4.addSocialMedia("Facebook", "system.SAD: Special Advertising Directory Profile");
        adv4.addSocialMedia("Twitter", "system.SAD: Special Advertising Directory Twitter Page");
        ...
        Listing[] facebookTest = SearchListings.searchByAdvertisersSocialMedia(aa, la, "Facebook", "Business.net Profile");
        Listing[] twitterTest = SearchListings.searchByAdvertisersSocialMedia(aa, la, "Twitter", "Heroes.org Twitter Page");
        Listing[] linkedinTest = SearchListings.searchByAdvertisersSocialMedia(aa, la, "LinkedIn", "Antonio Anthony Antony II");
    ...
    public void testCanSearchById(){
        ...
        Listing[] theListings = SearchListings.searchByAdvertisersID(aa, la, adv0.getId());
        Listing[] expected = {list0, clist0, hlist0};

        assertArrayEquals("Can Obtain Listings from Searching By Advertiser\'s ID", expected, theListings);
    }
    @Test
    public void testNullIsReturnedWhenNeeded() {
        ...
        Listing[] emailAddressTest = SearchListings.searchByAdvertisersEmailAddress(aa, la, "a@a.com");
        Listing[] lastNameTest = SearchListings.searchByAdvertisersLastName(aa, la, "Davidson");
        Listing[] businessNameTest = SearchListings.searchByAdvertisersBusinessName(aa, la, "Business");
        Listing[] phoneNumberTest = SearchListings.searchByAdvertisersPhoneNumber(aa, la, "(123)123-123");
