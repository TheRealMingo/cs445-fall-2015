...
public class AdvertisersArrayTest {
    ...
    public void testAdvertiserArrayHasAdvertisers(){
        ...
        assertEquals("Advertiser has more than 0 advertiser", 5, advertisers.totalAmountofAdvertisers());
    }
    ...
    public void testAdvertiserArrayCanHaveOver100Elements(){
        ...
        assertEquals("Advertiser has over 100 elements", 300, advertiserArray.totalAmountofAdvertisers());
    }
